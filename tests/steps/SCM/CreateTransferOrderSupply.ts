...
When('User send the post request to the endpoint', async function () {
    ...
    console.log(this.SCMURL, "fscmRestApi/resources/11.13.18.05/supplyRequests")
...
When('User enter the Transfer Order Number', async function (this: ICustomWorld) {
    ...
    await this.scmTransferOrdersPage.SearchTransferOrder(data.transferOrderNumber.trim());
...
let getIF206Response: AxiosResponse;
...
When('Click on Confirm Shipment for Customer SO', async function (this: ICustomWorld) {
