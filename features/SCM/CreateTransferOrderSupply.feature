Feature: Validate Transfer Order Creation receiving process
    ...
    @api @BSM
    Scenario: Create Transfer Order for "<product>" and receive at branch "<DestinationOrg>"
        Given the API end point for Create Transfer Order API
        When user update the payload for TO with "<product>","<DestinationOrg>","<DestinationSubOrg>","<SourceOrg>","<quantity>"
    ...
    @SCM @BSM
    Scenario: Validate Transfer Order Status created in SaaS after Ship Confirm
        Given User login into SCM application
        When User Clicks on Home Icon
        And User navigate to Inventory Management
        And  Select the "<SubInventory>" on InventoryManagement Screen
    ...
    @SCM @BSM
    Scenario: Validate Transfer Order Status  in SaaS after Received
        Given User login into SCM application
        When User Clicks on Home Icon
        And User navigate to Inventory Management
        And  Select the "<SubInventory>" on InventoryManagement Screen
    ...
    @SCM @BSM
    Scenario: Perform PutAway for the TO created
        Given User login into SCM application
        When User Clicks on Home Icon
        And User navigate to Inventory Execution
    ...
    @api @BSM
    Scenario: Create Customer Sales Order for "<product>" and branch "<DestinationOrg>"
    ...
    @SCM @BSM
    Scenario: Validate Line Status after performing Pick Relase for the Transfer Order
        Given User login into SCM application
        When User Clicks on Home Icon
        And User navigate to Inventory Management
        And  Select the "<SubInventory>" on InventoryManagement Screen
    ...
    @SCM @BSM
    @conditionalSkipping
    Scenario: Perform Confirm Pick for the TO created
        Given User login into SCM application
        When User Clicks on Home Icon
        And User navigate to Inventory Execution
    ...
    @SCM @BSM
    @conditionalSkipping
    Scenario: Perform Ship Goods for the TO created
        Given User login into SCM application
        When User Clicks on Home Icon
        And User navigate to Inventory Execution
