Feature: Update Promise dates
    ...
    Scenario Outline: Validate Promise Date Update for "<orderType>"
        ...
        And User enters "<LocationName>" in warehouse dropdown
        ...
        Examples:
            | customer                        | orderType    | Item   | Location | LocationName  |
            | WALKER PLUMBING & HEATING,88605 | Branch Order | R40003 | 1BL      | Peckham - 1BL |
