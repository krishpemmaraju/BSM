Feature: Create Customer Sales Order with Fixed Kits
    ...
    @api
    Scenario Outline: Create Customer Sales Order for Variable Kits with Parent Product "<Parentproduct>", Optional Product "<VariableProduct>", Child Product "<ChildProduct>" for branch "<DestinationOrg>"
        ...
        Examples:
            | Parentproduct | VariableProduct | ChildProduct | DestinationOrg | quantity | productPrice |
            | P28601        | GAS & WATER     | BE0814       | 1BL            | 2        | 116.50       |
